...
class Notification {
 public:
  ...
  static Notification MakePublishMuteOrUnmuteNotification(const std::string& notify_room_id,
                                                          ...
                                                          const std::string& publish_stream_id);
  static Notification MakeParticipantJoinedNotification(const std::string& notify_room_id,
                                                        const std::string& participant_id);
  static Notification MakeParticipantLeftNotification(const std::string& notify_room_id,
                                                      const std::string& participant_id);
 ...
 private:
  Notification(const std::string& notify_room_id,
