...
Notification::Notification(const std::string& notify_room_id, const std::string& notify_participant_id, const nlohmann::json& context)
    : notify_room_id_{notify_room_id}, notify_participant_id_{notify_participant_id}, notify_context_{context} {}
...
Notification Notification::MakeParticipantJoinedNotification(const std::string& notify_room_id, const std::string& participant_id) {
  nlohmann::json context;
...
Notification Notification::MakeParticipantLeftNotification(const std::string& notify_room_id, const std::string& participant_id) {
  nlohmann::json context;
